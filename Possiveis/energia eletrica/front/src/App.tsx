...
import ContasPorBandeira from './components/pages/conta/ContasPorBandeira';
      ...
      <div className="App">
        <nav>
          <ul>
            ...
            <li>
              <Link to="/pages/conta/bandeira">Por Bandeira</Link>
            </li>
          </ul>
        </nav>
        <Routes>
          ...
          <Route path="/pages/conta/bandeira" element={<ContasPorBandeira />} />
        </Routes>
      </div>
    </BrowserRouter>
  );
